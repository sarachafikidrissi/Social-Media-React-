  ...
  return (
    <div className='navbar flex justify-between flex-row px-5'>
      <div className='leftNav flex gap-52'>
        <img className="w-[70px] ml-4 sm:ml-0" src={logo} alt="Logo" />
        <div className="relative items-center hidden md:inline-flex">
          <input type="text" placeholder="Search" className="border border-gray-200 rounded-md py-1 px-2 w-[35vw]" />
      ...
      <div className="group relative cursor-pointer py-2">
        ...
        <div className="invisible bg-white cursor-pointer absolute z-50 mt-2 rounded-md flex w-full flex-col py-5 px-4 text-gray-800 shadow-xl group-hover:visible">
          <div className='cursor-pointer hover:bg-hoverBtn hover:rounded-md w-[100%] ps-5 text-xl pb-2 flex flex-row gap-4 items-center'>
            <div><CiUser /></div><Link to={"/profile"}> Profile</Link>
          </div>
          <div className='cursor-pointer hover:bg-hoverBtn hover:rounded-md w-[100%] ps-5 text-xl pb-2 pt-1 flex flex-row gap-4 items-center'>
            <div><MdOutlineEdit /></div><Link to={"/edit-profile"}>Edit</Link>
          </div>
          <div className='cursor-pointer hover:bg-hoverBtn hover:rounded-md w-[100%] ps-5 text-xl pb-2 pt-1 flex flex-row gap-4 items-center'>
            <div><CiLogout /></div><Link to={"/login"} onClick={handleLogout}>Logout</Link>
          </div>
        </div>
      </div>
    </div>
