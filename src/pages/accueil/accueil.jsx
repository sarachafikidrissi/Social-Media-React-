...
const Accueil = () => {
    ...
    return (
        ...
        <div className={`bg-gradient-to-b from-[#b1a49f]  to-[#8433ac] h-[100vh] ${darkmode && "bg-[#242424]" }` }  >
            <div className="flex justify-between">
                ...
                <div className='flex gap-3 p-10 items-center'>
                    <button className={`self-start px-8 py-3 leading-none text-gray-200 bg-btnColor hover:bg-hoverBtn rounded-full font-serif ${darkmode && "bg-[#464545] && hover:bg-white && hover:text-black "}`}>
            ...
            <div className='flex  gap-[1rem] '>
                <div className='pt-8'>
                    ...
                    <button  className='text-white ms-[4rem] bg-gradient-to-b from-[#746d6a]  to-[#661b8c] font-serif py-3 px-9 rounded-full  '>Join Now</button>
                </div>
