...
const GroupPage = () => {
 ...
 bg-gradient-to-b from-[#c17d7d] to-[#d76a83] 
    hover:from-[#af7878] hover:to-[#ae385e] text-white px-4 py-2 rounded-lg">
                Post
            </button>
        </div>
    </div>
            ...
            <div key={index} className="w-[70%] bg-[#FAF2EA] p-4 rounded-lg shadow-md mb-4 mx-40">
              ...
              <div className='ml-3'>
                ...
                {post.images && post.images.length > 0 && (
                    <div className="mt-4">
                        {post.images.map((image, idx) => (
                            <img key={idx} src={image} alt={`uploaded ${idx}`} className="w-full h-auto rounded-lg shadow-lg mb-4" />
                        ))}
                    </div>
                )}
                {post.video && (
                ...
                <div className='flex justify-between items-center border-t pt-2'>
                    ...
                    >
                        <IoHeart color={post.likes > 0 ? 'red' : 'black'} />
                        Like 
                    </button>
                    <button
                        className='flex items-center text-slateGray hover:text-royalBlue'
