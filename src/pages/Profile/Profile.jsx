            ...
            <div >
              <div className='flex'>
                <div className='w-[30vw] flex justify-center items-center'>
                  <div className=' w-[60%] h-[85%] rounded-full'>{filterConnectedUser.profileImage ? (
                    <img src={filterConnectedUser.profileImage} className='w-[15vw] h-[30vh] rounded-full'/>
                  ) : (
                ...
                <div className='w-[50vw] h-[45vh] flex items-center'>
                  <div className='flex flex-col gap-5'>
                    ...
                    <div className='flex gap-10 text-1xl font-serif'>
                      <h1>{filterConnectedUser.userPost.length} Posts</h1>
                      <h1>{filterConnectedUser.username.length} Followers</h1>
                      <h1>{filterConnectedUser.username.length} Following</h1>
                    </div>
              ...
              <div className='flex gap-5 flex-wrap ms-[1rem]  bg-[#a19a9a7a] rounded-md'>
                  ...
                  <div  className='w-[24vw] rounded-md'>
                    <div className='bg-white flex gap-5 rounded-t-md border-b-4 p-2'>
                      <div className='profil bg-[#fcfc] w-[4vw] h-[8vh] rounded-full'>
                        ...
                        {filterConnectedUser.profileImage ? (
                          <img src={filterConnectedUser.profileImage}  className='w-full h-full rounded-full'/>
                        ) : (
                    ...
                    <div className='w-[100%]'>
                      <img className='h-[50vh] w-full bg-cover' src={filterConnectedUser.image}  />
                    </div>
                    <div className='bg-white w-[24vw] h-[10vh] rounded-b-md text-black flex justify-between items-center p-2'>
                    <h1>{filterConnectedUser.userPost.likes} Like</h1>
                    <h1>{filterConnectedUser.userPost.comments} Comments</h1>
                      <h1>{filterConnectedUser.userPost.favorited}favorite</h1>
                    </div>
                  </div>
