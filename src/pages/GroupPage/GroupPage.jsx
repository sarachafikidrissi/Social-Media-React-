  ...
  return (
    <div className="flex gap-5 items-center w-full justify-center">
      ...
      <div className='pb-8 w-full gap-10'>
        ...
        />
        <div>
          <h1 className="text-4xl p-5">basma rajae</h1>
        </div>
        <div className='flex justify-between items-center px-10'>
          <div><p className='flex gap-2 items-center'> <HiOutlineUserGroup color="#c17d7d" size="30px" /> Membres</p></div>
          <div className='flex justify-evenly gap-5'>
            <button className="mt-4 px-6 py-2 bg-gradient-to-b from-[#c17d7d] to-[#d76a83] hover:from-[#af7878] hover:to-[#ae385e] text-white rounded-lg">{suivre ? `+Inviter` : `Join`}</button>
            <button className="mt-4 px-6 py-2 bg-gradient-to-b from-[#c17d7d] to-[#d76a83] hover:from-[#af7878] hover:to-[#ae385e] text-white rounded-lg">Share</button>
            <div className="relative">
              <button
                className="mt-4 px-6 py-2 bg-gradient-to-b from-[#c17d7d] to-[#d76a83] hover:from-[#af7878] hover:to-[#ae385e] text-white rounded-lg"
              ...
              {showSettings && (
                <div className="absolute right-0 mt-2 bg-white border border-gray-300 rounded-lg shadow-lg">
                  <button onClick={() => setSuivre(false)} className="mt-4 px-6 py-2 bg-gradient-to-b from-[#c17d7d] to-[#d76a83] hover:from-[#af7878] hover:to-[#ae385e] text-white block w-full text-center rounded-lg">Ne plus suivre</button>
                  <button className="mt-4 px-6 py-2 bg-gradient-to-b from-[#c17d7d] to-[#d76a83] hover:from-[#af7878] hover:to-[#ae385e] text-white block w-full text-center rounded-lg">Quitter le groupe</button>
                </div>
              )}
            </div>
          </div>
        ...
        {/* Create Post */}
        <div className="w-3/4 p-4 rounded-lg bg-[#FAF2EA] shadow-md mt-4 mx-40">
