            ...
            <h1 className=' text-end text-4xl cursor-pointer'><span onClick={() => navigate('/')} className='hover:text-red-600'>x</span></h1>
                ...
                {/* create bg cover */}
                    <div
                        ...
                        {/* create  bg profil */}
                        <div
                            class="mx-auto flex justify-center w-[141px] h-[141px] bg-blue-300/20 rounded-full bg-[url('https://gem.ec-nantes.fr/wp-content/uploads/2019/01/profil-vide.png')] bg-cover bg-center bg-no-repeat">
